...
with st.sidebar:
    ...
    model_choice = st.selectbox("Model", ["gemma:2b", "mistral", "llama3:8b"], index=["gemma:2b","mistral","llama3:8b"].index(LLM_MODEL) if LLM_MODEL in ["gemma:2b","mistral","llama3:8b"] else 0)
